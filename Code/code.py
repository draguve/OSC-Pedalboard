...
while(True):
    pixels[0] = (clerp(0,255,chan_slider.value/32767),0,0)
    pixels[1] = (clerp(0,255,chan_knob0.value/32767),0,0)
    pixels[2] = (clerp(0,255,chan_knob1.value/32767),0,0)
    pixels[3] = (clerp(0,255,chan_knob2.value/32767),0,0)
    pixels[4] = (clerp(0,255,chan_knob3.value/32767),0,0)
    pixels[5] = (clerp(0,255,chan_knob4.value/32767),0,0)
